# Ejercicio 2: Leer un recurso FHIR Patient desde HAPI FHIR

A partir del ID generado en el ejercicio anterior, lea el recurso desde el servidor FHIR donde se persistió:
